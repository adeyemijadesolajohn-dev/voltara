...
const CreateAccount = () => {
	...
	function updateFormSteps() {
		formSteps.forEach((formStep) => {
			formStep.classList.contains('formStepActive') && formStep.classList.remove('formStepActive');
		});
		...
		<div className="createContainer">
			<nav className="navBar">
				...
				<div className="navHeading">
					<h1 className="navHeadingText">Create Account</h1>
				</div>
			</nav>
			...
			<form action="#" className="form">
				<div className="progressbar">
					...
					<div className="progressstep progressstepactive" data-title="1: Contact Details"></div>
				...
				<div className="formStep formStepActive">
					{/* <div className="labelHeading">
						<h3 className="leftHeading currentHead">Contact Details</h3>
						<h3 className="middleHeading">Service Type</h3>
						<h3 className="middleHeading">Tariff Type</h3>
						<h3 className="rightHeading">Finish</h3>
					</div> */}
				...
				<div className="formStep">
					{/* <div className="labelHeading">
						<h3 className="leftHeading">Contact Details</h3>
						<h3 className="middleHeading currentHead">Service Type</h3>
						<h3 className="middleHeading">Tariff Type</h3>
						<h3 className="rightHeading">Finish</h3>
					</div> */}
					<div className="inputGroup">
						<div className="inputText">
							<div className="flex createCheckBox">
								...
								<div className="label">
									<h3>Postpaid</h3>
									<input type="checkbox" id="Customer" name="Customer[1][]" value="1" />
								</div>
							</div>
						</div>
				...
				<div className="formStep">
					{/* <div className="labelHeading">
						<h3 className="leftHeading">Contact Details</h3>
						<h3 className="middleHeading">Service Type</h3>
						<h3 className="middleHeading currentHead">Tariff Type</h3>
						<h3 className="rightHeading">Finish</h3>
					</div> */}
					<div className="inputGroup">
						<div className="inputText">
							<div className="flex createCheckBox">
								...
								<div className="label">
									<h3>Residential</h3>
									<input type="checkbox" id="Customer" name="Customer[2][]" value="1" />
								</div>
							</div>
						</div>
				...
				<div className="formStep">
					{/* <div className="labelHeading">
						...
						<h3 className="middleHeading">Service Type</h3>
						<h3 className="middleHeading">Tariff Type</h3>
						<h3 className="rightHeading finishHead">Finish</h3>
					</div> */}
					<div className="inputGroup">
						...
						<div className="text congrats">
							...
							<p className="congratsText">
								Thanks Mr./Mrs. <span className="shownName"></span>, your information has been submitted
								successfully.
							</p>
						</div>
